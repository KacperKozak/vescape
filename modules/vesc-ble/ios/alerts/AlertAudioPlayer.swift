...
/// @parity /modules/vesc-ble/android/src/main/java/expo/modules/vescble/VescAlerts.kt `AlertSoundPreset`
...
/// @parity /modules/vesc-ble/android/src/main/java/expo/modules/vescble/VescAlerts.kt `resolveAlertPreset`
...
/// `AVSpeechSynthesizer` for Alert Message Templates. Mirrors Android `VescAlertFeedback`
...
/// (music during a ride).
///
/// @parity /modules/vesc-ble/android/src/main/java/expo/modules/vescble/VescAlerts.kt `VescAlertFeedback`
...
internal final class AlertAudioPlayer {
  ...
  private func bundledAssetsURL() -> URL? {
    ...
    if let url = moduleBundle.url(forResource: "VescBleAssets", withExtension: "bundle") {
      return url
    }
    return nil
  }
