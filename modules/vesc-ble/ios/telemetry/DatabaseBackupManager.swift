...
///
/// @parity /modules/vesc-ble/android/src/main/java/expo/modules/vescble/telemetry/DatabaseBackupManager.kt
...
enum DatabaseBackupManager {
  ...
  static func createBackup() throws -> [String: Any?] {
    ...
    let stamp = utcStamp()
    let sqliteExport = exportDir.appendingPathComponent("telemetry-\(stamp).sqlite")
