...
/// idempotency key: `BoardSessionController.stopBoard()` clears it synchronously, so a duplicate
/// intent cannot repeat teardown. The tombstone also prevents a later module bootstrap from
/// immediately auto-connecting the Board the rider just stopped.
