 ...
 */
export type SentryManifestProblem = string

export const sentryNativeInitProblems = (mergedManifest: string): SentryManifestProblem[] => {
  ...
  const problems: SentryManifestProblem[] = []
