...
function country(
  input: Omit<
    LegalLimitCountry,
    'checkedAt' | 'sourceUrl' | 'warningText' | 'speedLimitBasis' | 'referenceSpeedKmh'
  > & {
    referenceSpeedKmh?: number | null
    sourceUrl?: string
    speedLimitBasis?: string
  ...
  return {
    ...
    referenceSpeedKmh: input.referenceSpeedKmh ?? input.legalSpeedKmh,
...
export const LEGAL_LIMIT_COUNTRIES: readonly LegalLimitCountry[] = [
  ...
  country({
    ...
    alpha3: 'BGR',
    legalSpeedKmh: null,
    warningSpeedKmh: null,
    referenceSpeedKmh: 25,
    status: 'unknown',
    confidence: 'low',
